...
public class PokerTest {
	...
	@Test
	public void test_isThreeOfaKind_01() {
		boolean result;
		String[] input = new String[] {"CA", "DX", "HX", "SX", "DK"};
	...
	@Test
	public void test_isThreeOfaKind_02() {
		boolean result;
		String[] input = new String[] {"CA", "D2", "HX", "SX", "DK"};
		result = poker.isThreeOfaKind(input, 5);
		assertEquals(false, result);
	}
	@Test
	public void test_isTwoPair_01() {
		boolean result;
		String[] input = new String[] {"CA", "DX", "HX", "SX", "DK"};
	...
	@Test
	public void test_isTwoPair_02() {
		boolean result;
		String[] input = new String[] {"CA", "DA", "H6", "S6", "D7"};
		result = poker.isTwoPairs(input, 5);
		assertEquals(true, result);
	}
}
